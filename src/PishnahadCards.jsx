        ...
        <div className="  bg-white border flex flex-col items-center justify-center border-gray-200 rounded-lg shadow ">
          <div className="ImageZone  relative">
            ...
            <div className=" emergingHypers   absolute w-[55px] top-[20px] right-[7px] text-white text-center text-sm  p-[1px] bg-[#caa984] rounded-2xl shadow-lg  flex justify-center">
              <div>%</div>
              <div>
                <PersianNumber number={props.discount_Benefit_Percent} />
              </div>
              <div>{props.MinusOrPlus}</div>
            </div>
            <div
              className="emergingHypers absolute w-auto   top-[20px]  text-black text-center text-sm   bg-white rounded-2xl shadow-lg   flex flex-col justify-around"
              style={{ height: "170px", padding: "0px 12px" }}
            >
              <a href="#">
                <svg
          ...
          <div className="p-5">
            <a href="#">
              <h5 className="mb-2 font-bold tracking-tight  text-[#858585] text-start">
                {props.productName}
              </h5>
            </a>
            ...
            <div className="pricezone flex  justify-start mb-2">
              <div className="previousprice text-[10px] px-2 line-through  text-[#bbbbbb]">
                <PersianNumber number={props.lastPrice} />
              </div>
              <div className="currentprice text-xs text-[#d0b493]">
                <PersianNumber number={props.lastPriceWithDiscount} />
                تومان
              </div>
            </div>
            <hr style={{ display: "block" }} />
            <div className="clockZone mt-2" style={{ display: "block" }}>
              <div className=" clockNumbers flex justify-between font-bold text-lg	">
                <div>
                  {" "}
                  <PersianNumber number={36} />{" "}
                </div>
                <div>
                  {" "}
                  <PersianNumber number={48} />{" "}
                </div>
                <div>
                  {" "}
                  <PersianNumber number={12} />{" "}
                </div>
                <div>
                  {" "}
