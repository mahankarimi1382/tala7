  ...
  return (
    <div>
      ...
      <div className="flex mx-11 mt-9 gap-4">
        ...
        <div className="w-[70%] p-4 border border-gray-200 rounded-lg">
          {/* Title */}
          ...
          <div className="flex gap-4 items-center p-4 border-b border-gray-200">
            ...
            {/* Product Name */}
            <p className="text-md font-medium">حلقه رزگلد زیبا</p>
          </div>
        ...
        <div className="w-[25%] border border-gray-200 rounded-lg p-5 flex flex-col space-y-4">
