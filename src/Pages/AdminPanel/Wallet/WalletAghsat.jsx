...
import {
  ...
  SharzhWallet_Wallet_Installment_Purchase,
  ...
  return (
    <div className=" w-full min-h-screen flex items-center">
      ...
      {isModal && (
        <AddThingsModal
          submitFn={() =>
            SharzhWallet_Wallet_Installment_Purchase(data, setIsModal)
          }
          title="شارژ تومان"
        ...
        >
          <div className=" flex flex-col gap-2  rounded w-full">
            <input
              ...
              placeholder="تومان"
            />
            <p className="">موجودی فعلی: {walletInfo.exist_toman} تومان</p>
          </div>
          <p> لیست تراکنش ها</p>
      ...
      <div className=" w-full lg:w-5/6 flex p-5 justify-center h-screen">
        <div className=" w-full rounded p-2 bg-white shadow-xl h-full flex flex-col">
          <div className=" w-full flex flex-col gap-5 items-start">
            <h5 className=" text-xl font-semibold">کیف پول تومان</h5>
