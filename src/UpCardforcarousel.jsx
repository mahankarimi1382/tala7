...
import moveImageLeft from "../src/Components/moveImageLeft";
import "./index.css";

function UpCardforcarousel({IMGAddress}) {
  ...
  return (
    <>
      <div className="  h-full w-full visible[!important] blink_me">
        <div className="absolute aspect-[6/1]	 h-full   w-full mx-auto shadow-2xl rounded-lg bg-gradient-to-r  from-teal-950 to-teal-900">
          {/* Text Content */}
          <div className=" nevehteha p-8 absolute">
            <p className=" Ersale text-[3vw]  lg:text-[2vw] font-bold mb-6[!important] mr-4[!important] text-white animate-fade-in-for-card-texts-2">
              ارسال سریع به سراسر ایران
            </p>
            <p className=" Jadidtar text-[2vw]  lg:text-[1.3vw] text-white  animate-fade-in-for-card-texts-2">
              جدیدترین مدل حلقه های وارداتی
            </p>
            <button
              style={{ backgroundColor: "#c7a984" }}
              className=" moshahede animate-fade-in-for-card-texts-2 text-xs 
                text-1.vw  
          ...
          <img
            ...
            src={IMGAddress}
            alt="Image 2"
              className=" md:halghe-applied halgheKoochak-applied animate-fade-in-for-ring-Y-move-2  
            md:ml-14 md:-mt-16 md:w-[300px!important] md:h-[300px!important]
            w-[150px!important] h-[150px!important]
            "
          />
          </div>
        </div>
...
export default UpCardforcarousel;
