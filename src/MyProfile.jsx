      ...
      <div className="px-8">
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 items-start">
                    ...
                    {isSubmitted ? (
                      ...
                      <div className="flex flex-col w-48">
                        <input
                          ...
                          className="text-sm border-2  px-3 py-2 focus:border-gray-400 focus:outline-none transition-colors duration-200 w-full"
                        />
                    ...
                    {isSubmitted ? (
                      ...
                      <div className="flex flex-col w-48">
                        <input
                          ...
                          className="text-sm border-2 focus:border-gray-400 px-3 py-2  focus:outline-none transition-colors duration-200 w-full"
                        />
          ...
          <div className="flex flex-col">
            ...
            <div className="w-full xl:flex justify-center hidden mt-10">
            {!isSubmitted && (
              <button
                onClick={() =>
          ...
          {/* SVG Image */}
          <div className="w-full flex justify-center border-2 border-slate-100 rounded-lg">
            <img src={svgImage} alt="Profile" className="w-full max-w-[500px]" />
          </div>
