...
function DownCard() {
  ...
  return (
    <>
      <div className="mt-11  ">
        <div className="relative lg:h-[330px] sm:p-6  bg-white shadow-lg  col-start-1 col-span-12 bg-gradient-to-l  from-teal-950 to-teal-900">
          {/* Text Content */}
          <div className="p-4">
          ...
          <img
            ...
            src={imgRing}
            alt="Image 2"
            className="  absolute bottom-0  halghe left-0 -mb-44 md:-mb-52 lg:-mb-[60px] ml-8 w-[35%] md:w-[28%] lg:w-[18%] h-auto filter drop-shadow-[0_10px_5px_rgba(0,0,0,0.25)]"
            style={image2Style}
          />
        </div>
      </div>
